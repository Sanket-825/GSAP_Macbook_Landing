...
Files: macbook-14.glb [629.72KB] > F:\React-ThreeJs-GSAP-Tailwind Project\Macbook_Project\public\models\macbook-14-transformed.glb [627.9KB] (0%)
...
export default function MacbookModel14(props) {
  ...
  const { nodes, materials, scene } = useGLTF(`${base}models/macbook-14-transformed.glb`)
